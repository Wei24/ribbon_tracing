Function work_flow_20170918, dta
  ...
  index_array = intarr(size_dta[0],size_dta[1],size_dta[2])
  ...
  for i3 = 0, size_dta[2] - 3 do begin
    ...
    for i4 = 0, size_dta[1]-1 do begin
      ...
      speed_array[i4,i3,1] = float(dta[index_array[i4,i3],i4,i3,1])
      speed_array[i4,i3,2] = float(dta[index_array[i4,i3],i4,i3,2])
      speed_array[i4,i3,3] = float(dta[index_array[i4,i3],i4,i3,3])
      speed_array[i4,i3,4] = float(dta[index_array[i4,i3],i4,i3,4])
      speed_array[i4,i3,5] = float(index_array[i4,i3])
    endfor
  endfor
  return, speed_array
end
